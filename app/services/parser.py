...
#__________________________________________________________________________________
     ...
     #    try:
     #      for column_id, (slot_theory, slot_lab) in enumerate(zip(theory_timing,lab_timing)):
     #           db.session.add(Time(column_id, slot_theory['start'], slot_theory['end'], 'ETH'))
     #           db.session.add(Time(column_id, slot_lab['start'], slot_lab['end'], 'ELA'))
     #      db.session.commit()
